...
// ✅ API ROUTES FIRST (more specific routes should come before general ones)

// API endpoint: create tenant (used by React frontend)
router.post("/property/:propertyId/tenant", async (req, res) => {
  console.log("Property endpoint")
  const { propertyId } = req.params;
  const { testEmail } = req.query;
  const {
    unit,
...
// ✅ HTML FORM ROUTES LAST (general routes should come after specific ones)
...
// router.post("/:id", async (req, res) => {
//   const unitId = req.params.id;
//   console.log("hitting id endpoint")
//   try {
//     const {
//       name,
//       email,
